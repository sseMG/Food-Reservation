      ...
      <main className="max-w-5xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-6">
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Add {form.category}</h1>
              <p className="text-sm text-gray-600">Create a new item for the canteen menu</p>
            </div>
          </div>
        </div>
          ...
          <div className="p-4 sm:p-6 space-y-6">
                ...
                {imagePreview ? (
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Upload an appetizing photo of the item</p>
                    </div>
                    <button
                      onClick={openPicker}
                      type="button"
            ...
            <div>
              ...
              <input
                ...
                placeholder={`e.g., Chicken Adobo w/ ${form.category}`}
